...
(function () {
  ...
  if (cmd === "cp") {
    copyFiles(sourceRootDir, `${targetRootDir}/react-file-picker/lib`);
    ...
    rootFiles.forEach((file) => {
      ...
      if (stats.isFile()) {
        fs.copyFileSync(file, `${targetRootDir}/react-file-picker/${file}`);
      }
    });
    ...
    const packageJsonPath = path.resolve(__dirname, '../@ihatecode/react-file-picker/package.json');
